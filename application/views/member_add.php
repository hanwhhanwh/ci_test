  ...
  <tbody>
    <tr>
      <th scope="row" style="vertical-align:middle" class="mycolor2">
		...
		<td align="left"><div class="form-inline"><input type="text" class="form-control form-control-sm" name="user_name" size="20" maxlength="30"></div></td>
    </tr>
    <tr>
      <th scope="row" width="20%" style="vertical-align:middle" class="mycolor2">
		<font color="red">*</font> 아이디</th>
		<td align="left"><input type="text" class="form-control form-control-sm" name="user_id" size="20" maxlength="30"></td>
    </tr>
    <tr>
      <th scope="row" style="vertical-align:middle" class="mycolor2">
    ...
    <tr>
	  ...
	  <td align="left"><label><input type="radio" name="rank" value="0"> 관리자</label> <label><input type="radio" name="rank" value="1" > 직원</label></td>
    </tr>
  </tbody>
</table>
<div align="center">
