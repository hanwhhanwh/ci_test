<form id="form_add_member" method="PUT" action="/member/update">
...
?>
    <tr>
      <th scope="row" style="vertical-align:middle" class="mycolor2">
		...
		<td align="left"><div class="form-inline"><input type="text" class="form-control form-control-sm" name="user_name" size="20" maxlength="30" <?php if (isset($member)) echo "value=\"{$member->user_name}\""; ?></div></td>
    </tr>
    <tr>
      <th scope="row" width="20%" style="vertical-align:middle" class="mycolor2">
		<font color="red">*</font> 아이디</th>
		<td align="left"><input type="text" class="form-control form-control-sm" name="user_id" size="20" maxlength="30" <?php if (isset($member)) echo "value=\"{$member->user_id}\""; ?>></td>
    </tr>
    <tr>
      <th scope="row" style="vertical-align:middle" class="mycolor2">
		<font color="red">*</font> 암호</th>
		<td align="left"><div class="form-inline"><input type="password" class="form-control form-control-sm" name="password" size="20" maxlength="30"></div></td>
    </tr>
    <tr>
